...
- Pay close attention to punctuation in code! For FIJI/ImageJ, make sure the code of each line ends in a semicolon (not comments) and quotes are correctly placed
